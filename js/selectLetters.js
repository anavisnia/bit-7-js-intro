function pickLetters(text, step) {
    ...
    if (step > size) {
        return 'ERROR: zinfsnis yra per didelis lyginant su teksto ilgiu'
    }
    if (step === 0) {
...
console.log(pickLetters('abijkl',1.4), '->', 'cfil');
console.log(pickLetters('abcdefghijkl',1.2), '->', 'cfil');
console.log('-------------------------------------');
